...
class SearchBarForWindow: UIView, UITextFieldDelegate {
    ...
    private let iconSearchGray = UIImageView()
    ...
    init() {
        ...
        self.iconSearchGray.image = UIImage(named: "iconSearchGray")
        ...
        self.grayBackground.addSubview(self.iconSearchGray)
        ...
        self.iconSearchGray.snp.makeConstraints{ (make) in
        ...
        self.textField.snp.makeConstraints{ (make) in
            make.height.equalTo(36)
            make.top.equalToSuperview()
            make.left.equalToSuperview().offset(36-10)
